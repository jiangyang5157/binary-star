...
def send_mock_emails():
    ...
    review_record = {
        ...
        "analysis": {
            ...
            "adversarial_audit": {
                "shadow_evidence": [
                    "Excellent entry accuracy confirmed by 0.44% max drawdown.",
                    "Minimal pressure observed during the 2.5 hour holding period."
                ],
