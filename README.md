...
### 第六层：动态立场翻转 (Pivot Mandate)
**核心逻辑：政权适应性生存。** 彻底终结“方向死锁”。当 Critic 识别出结构性陷阱（如波动扩张或零售挤压）时，Strategist 有权并在特定条件下被强制在 Phase B 翻转初始立场（如由多转空）。这确保了系统能从被动的“死扛风险”转为主动的“顺势猎杀”。
