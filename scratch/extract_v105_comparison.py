...
for ts in all_ts:
    ...
    if d105:
        rows.append({
            ...
            'v105_Op': d105['opinion'],
            'v105_Res': d105['result'],
            'v105_MAE': d105['mae_stress']
        })

print(f"| Timestamp | Src_Res | v10.4_Res | v10.5_Op | v10.5_Res | v10.5_MAE |")
print(f"| :--- | :--- | :--- | :--- | :--- | :--- |")
for r in rows:
    print(f"| {r['TS']} | {r['S_Res']} | {r['v104_Res']} | {r['v105_Op']} | {r['v105_Res']} | {r['v105_MAE']} |")
