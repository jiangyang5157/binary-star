    ...
    def evolve(
        ...
        try:
            ...
            prompt = self._prepare_prompt(
                ...
                trend_intensity_threshold=active_config.get('regime_parameters', {}).get('trend_intensity_threshold'),
                volatility_extreme_ratio=active_config.get('regime_parameters', {}).get('volatility_extreme_ratio'),
                structural_buffer_atr=active_config.get('regime_parameters', {}).get('structural_buffer_atr'),
                stop_loss_buffer_min=active_config.get('binary_star', {}).get('session', {}).get('stop_loss_buffer_min'),
                mae_threshold_pinpoint=active_config.get('audit_review', {}).get('mae_threshold_pinpoint'),
                mae_threshold_standard=active_config.get('audit_review', {}).get('mae_threshold_standard'),
                mae_threshold_luck=active_config.get('audit_review', {}).get('mae_threshold_luck'),
