...
2. SOURCE SUPREMACY: The `Observation Content` is the absolute ground truth. Do not ignore metrics or hallucinate levels not present in the telemetry. If critical flow data (e.g., cvd_trend, ls_ratio, liquidation_clusters) is 'Unavailable', you MUST output NEUTRAL.
