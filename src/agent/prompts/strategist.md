...
{{
    ...
    "reasoning": "Mathematical Scratchpad: [Base] +/- ([Multiplier] * [ATR]) = [Price] | Breakout Vectoring: [Boundary] +/- ({regime_breakout_buffer_atr} * ATR) = [Entry] | Logic Synthesis...",
