...
{{
    ...
    "hidden_risk": "MUST begin with ONE of these exact tags: [CLEAR], [MACRO_CONFLICT], [LIQUIDITY_VOID], [ABSORPTION_TRAP], [RETAIL_SQUEEZE], [VOLATILITY_EXPANSION], or [ANOMALY]. DO NOT invent tags. Follow the tag with 1-2 sentences of specific data-driven reasoning.",
