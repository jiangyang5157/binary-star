...
class TopographyEngine:
    ...
    def __init__(self, config_dict: Dict[str, Any], data_root: str, logger):
        ...
        self.chart_gen = ChartGenerator(
            ...
            up_color=obs_config.visual.up_color,
            down_color=obs_config.visual.down_color,
            bg_color=obs_config.visual.bg_color,
            poc_color=obs_config.visual.poc_color,
            vah_val_color=obs_config.visual.vah_val_color,
            current_price_color=obs_config.visual.current_price_color,
            volume_profile_width_ratio=obs_config.visual.volume_profile_width_ratio,
            ...
            render_dpi=obs_config.visual.render_dpi,
