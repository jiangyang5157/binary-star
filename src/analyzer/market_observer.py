...
class MarketObserverConfig:
    ...
    def from_dict(cls, cfg: Dict[str, Any]) -> "MarketObserverConfig":
        ...
        return cls(
            ...
            funding_rate_macro_lookback_candles=int(sampling['metric_windows']['funding_rate_macro_lookback_candles']),
            cvd_micro_lookback_candles=int(sampling['metric_windows']['cvd_micro_lookback_candles']),
            trend_intensity_macro_lookback_candles=int(sampling['metric_windows']['trend_intensity_macro_lookback_candles']),
            volatility_intensity_macro_lookback_candles=int(sampling['metric_windows']['volatility_intensity_macro_lookback_candles']),
